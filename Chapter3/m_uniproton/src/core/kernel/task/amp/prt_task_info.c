...
{
    return (bool)(((taskCb->taskStatus & OS_TSK_RUNNING) == 0) || (OS_INT_ACTIVE));
}
...
OS_SEC_L4_TEXT void OsTaskStackPeakGet(struct TskStackInfo *stackInfo)
{
    U32 *stack = NULL;
